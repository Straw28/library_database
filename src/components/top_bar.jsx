...
function TopBar() {
    ...
    return (
        <div style={{ display:'flex', justifyContent:'flex-end', alignItems:'center', padding:'10px', overflowX:'hidden'}}>
            ...
            <Link to='/login'> <button className='button-17' style={{top:'1%', marginRight:'50px', left:'94%'}}>Login</button> </Link> 
            <button className='button-17' onClick={toggleHours} style={{top:'1%', marginRight:'6%' }}>Hours</button>
